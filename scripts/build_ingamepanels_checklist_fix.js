...
const INGAMEPANELS_CHECKLISTS_FIX_SRC = path.resolve(__dirname, '..', 'qbt-ingamepanels-checklist-fix/src');
const INGAMEPANELS_CHECKLISTS_FIX_OUT = path.resolve(__dirname, '..', 'qbt-ingamepanels-checklist-fix/out');
...
createPackageFiles(path.resolve(INGAMEPANELS_CHECKLISTS_FIX_OUT, 'qbt-ingamepanels-checklist-fix'), 'manifest-base.json');
