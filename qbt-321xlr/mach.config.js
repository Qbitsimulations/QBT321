...
module.exports = {
    packageName: 'QBT_321N',
    packageDir: 'out/qbitsim-aircraft-a321-253',
    plugins: [
        imagePlugin({ limit: -1 }),
        postCssPlugin({
            extract: true,
...
function reactInstrument(name, additionalImports) {
    return {
        ...
        simulatorPackage: {
            ...
            isInteractive: false,
            fileName: name.toLowerCase(),
            imports: ['/JS/dataStorage.js', '/JS/QBT_321N/A32NX_Simvars.js', ...(additionalImports ?? [])]
        }
    };
}
